...
time_st = time()
sscale = 2
test, nb, dbg = run_as_patches(img, method = "kmeans", nb_iter = 8000, size_scaler = sscale)
...
show_img(loss_img, "FLIP loss image", size_scaler = sscale)
